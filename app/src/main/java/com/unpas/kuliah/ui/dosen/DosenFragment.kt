...
class DosenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fab.setOnClickListener {
            ...
            button.setOnClickListener {
                val nidn = nidnext.text.toString()
                val nama = namaText.text.toString()
                val gelarDepan = gelarDepanText.text.toString()
                val gelarBelakang = gelarBelakangText.text.toString()
                val pendidikan = pendidikanText.selectedItem.toString()
    ...
    private fun editDosen(dosen: DosenData) {
        ...
        button.setOnClickListener {
            val updatedInput1 = nidnext.text.toString()
            val updatedInput2 = namaText.text.toString()
            val updatedInput3 = gelarDepanText.text.toString()
            val updatedInput4 = gelarBelakangText.text.toString()
            val updatedInput5 = pendidikanText.selectedItem.toString()
